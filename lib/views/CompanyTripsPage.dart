...
class _CompanyTripsPageState extends State<CompanyTripsPage>
  ...
  Widget build(BuildContext context) {
    ...
    final currentTrips =
        trips.where((trip) => trip['date'].isAfter(DateTime.now())).toList();
    final pastTrips =
        trips.where((trip) => trip['date'].isBefore(DateTime.now())).toList();
